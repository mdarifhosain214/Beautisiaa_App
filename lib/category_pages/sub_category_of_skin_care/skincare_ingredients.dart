...
class SkinCareIngredients extends StatefulWidget {
  final String categoryName;
  const SkinCareIngredients({Key? key, required this.categoryName}) : super(key: key);

  @override
  State<SkinCareIngredients> createState() => _SkinCareIngredientsState();
}

class _SkinCareIngredientsState extends State<SkinCareIngredients> {
  Widget searchBar(){
    return Container(
